...
WHERE contains(Heritage, "High Elf") OR contains(Ancestry, "High Elf") AND contains(NoteIcon, "Character") AND !contains(Condition, "Dead")
SORT file.name ASC
