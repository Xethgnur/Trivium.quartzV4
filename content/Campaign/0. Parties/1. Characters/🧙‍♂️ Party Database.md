...
columns:
  ...
  Alignment:
    ...
    options:
      ...
      - { label: "LN", value: "LN", color: "hsl(62, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  AssociatedGroup:
    ...
    sortIndex: -1
    options:
      - { label: "Blackwood Company", value: "Blackwood Company", color: "hsl(341, 95%, 90%)"}
      - { label: "Noble House of Escence", value: "Noble House of Escence", color: "hsl(196, 95%, 90%)"}
      - { label: "Faraday Firearms", value: "Faraday Firearms", color: "hsl(29, 95%, 90%)"}
      - { label: "Illvidri Heralds", value: "Illvidri Heralds", color: "hsl(60, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  AssociatedReligion:
    ...
    sortIndex: -1
    options:
      - { label: "Illvidri Heralds", value: "Illvidri Heralds", color: "hsl(212, 95%, 90%)"}
      - { label: "The Giant's Way", value: "The Giant's Way", color: "hsl(202, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  WhichParty:
    ...
    sortIndex: -1
    options:
      - { label: "Party 1", value: "Party 1", color: "hsl(207, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Heritage:
    ...
    options:
      ...
      - { label: "Kalashtar", value: "Kalashtar", color: "hsl(55, 95%, 90%)"}
      - { label: "Rock", value: "Rock", color: "hsl(35, 95%, 90%)"}
      - { label: "Arcaedian", value: "Arcaedian", color: "hsl(172, 95%, 90%)"}
      - { label: "Unknown", value: "Unknown", color: "hsl(237, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Ancestry:
    ...
    options:
      ...
      - { label: "Arcaedian", value: "Arcaedian", color: "hsl(39, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
