...
columns:
  ...
  NoteIcon:
    ...
    sortIndex: -1
    options:
      - { label: "POI", value: "POI", color: "hsl(296, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Type:
    ...
    options:
      ...
      - { label: "Cave", value: "Cave", color: "hsl(280, 95%, 90%)"}
      - { label: "Ruins", value: "Ruins", color: "hsl(84, 95%, 90%)"}
      - { label: "House", value: "House", color: "hsl(102, 95%, 90%)"}
      - { label: "Sewers", value: "Sewers", color: "hsl(301, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Theme:
    ...
    options:
      ...
      - { label: "Elven", value: "Elven", color: "hsl(306, 95%, 90%)"}
      - { label: "Ruins", value: "Ruins", color: "hsl(226, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Terrain:
    ...
    options:
      ...
      - { label: "Cavernous", value: "Cavernous", color: "hsl(8, 95%, 90%)"}
      - { label: "Urban", value: "Urban", color: "hsl(88, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Settlement:
    ...
    options:
      ...
      - { label: "Dragon's Head", value: "Dragon's Head", color: "hsl(317, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
