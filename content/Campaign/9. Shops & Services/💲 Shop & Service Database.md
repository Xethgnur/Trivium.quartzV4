...
columns:
  ...
  AffiliatedGroup:
    ...
    sortIndex: -1
    options:
      - { label: "The Shadow Snappers", value: "The Shadow Snappers", color: "hsl(176, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Type:
    ...
    options:
      ...
      - { label: "Postal Service", value: "Postal Service", color: "hsl(33, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Location:
    ...
    sortIndex: -1
    options:
      - { label: "Massarnae", value: "Massarnae", color: "hsl(42, 95%, 90%)"}
      - { label: "Dragon's Head", value: "Dragon's Head", color: "hsl(107, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Kingdom:
    ...
    sortIndex: -1
    options:
      - { label: "Arcaedia", value: "Arcaedia", color: "hsl(73, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
