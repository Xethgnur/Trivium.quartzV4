...
columns:
  ...
  Exports:
    ...
    options:
      ...
      - { label: "Clockwork Engineering", value: "Clockwork Engineering", color: "hsl(213, 95%, 90%)"}
      - { label: "Stone", value: "Stone", color: "hsl(44, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Theme:
    ...
    options:
      ...
      - { label: "Steampunk", value: "Steampunk", color: "hsl(262, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Kingdom:
    ...
    sortIndex: -1
    options:
      - { label: "Arcaedia", value: "Arcaedia", color: "hsl(14, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  Terrain:
    ...
    options:
      ...
      - { label: "Mountains", value: "Mountains", color: "hsl(179, 95%, 90%)"}
      - { label: "Riverside", value: "Riverside", color: "hsl(40, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
